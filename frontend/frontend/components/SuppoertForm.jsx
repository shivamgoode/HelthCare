...
export default function Formfill() {
  ...
  return (
    <>
      ...
      {response && (
        <div className="relative max-w-3xl mx-auto mt-10 p-8 rounded-2xl bg-gradient-to-br from-green-50 to-white border border-green-100 shadow-xl text-slate-700">
